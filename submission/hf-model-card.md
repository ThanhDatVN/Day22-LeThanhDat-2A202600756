...
| max_length | 512 |
| Compute | Free Colab Tesla T4 16GB |

## Results

| Metric | Value |
|---|---|
| End reward gap (chosen − rejected) | +0.0436 |
| Final chosen reward | −0.5463 |
| Final rejected reward | −0.5900 |
| NB4 win/loss/tie (8 prompts, judge=gpt-4o-mini) | SFT 0 / DPO 1 / tie 7 (win-rate 0.5625) |

> Note on reward curves: Gap grew mainly because rejected fell faster than chosen (likelihood displacement, deck §3.4) — both rewards are negative, but chosen stayed higher than rejected throughout training.
